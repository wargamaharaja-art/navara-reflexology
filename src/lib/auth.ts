...
export function getDefaultPermissions(role: string): string[] {
  const superAdminPerms = [
    ...
    "PENGATURAN_CABANG", "PENGATURAN_PENGGUNA", "PENGATURAN_KOMISI", "LAYANAN_TERAPI", "FEEDBACK_PELANGGAN", "SYSTEM_LOGS"
  ];
  ...
  switch (role) {
    ...
    case "CASHIER":
      return [
        "DASHBOARD_ANALITIK", "RESERVASI_ONLINE", "BUKUPASIEN_REKAMMEDIS", "INVENTARIS_BARANG",
        "KEUANGAN_PEMASUKAN", "KEUANGAN_PENGELUARAN", "KEUANGAN_MUTASI",
        "PEGAWAI_TERAPIS", "PEGAWAI_STAFF", "PEGAWAI_ABSENSI", "PEGAWAI_SLIP", "PEGAWAI_MUTASI",
        "FEEDBACK_PELANGGAN"
      ];
    case "THERAPIST":
