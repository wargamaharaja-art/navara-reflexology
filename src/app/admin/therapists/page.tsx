...
export default function AdminTherapistsPage() {
  ...
  const filteredTherapists = therapists.filter(t => {
    ...
    const matchesStatus = showInactive ? true : t.isActive;
        ...
        <PageHeader 
          ...
          rightContent={
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
              <label className="flex items-center gap-2 cursor-pointer text-sm font-medium text-gray-600 bg-white border border-gray-200 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors w-full sm:w-auto justify-center">
                <input 
                  type="checkbox" 
